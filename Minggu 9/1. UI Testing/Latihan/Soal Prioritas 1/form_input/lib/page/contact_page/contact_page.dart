...
import 'package:form_input/model/contact_model.dart';
import 'package:form_input/page/contact_page/widget/header_contact_page.dart';
import 'package:form_input/theme/theme_color.dart';
import 'package:form_input/theme/theme_text_style.dart';
import 'package:form_input/widget/button_widget.dart';
import 'package:form_input/widget/text_field_widget.dart';
            ...
            child: Row(
              ...
              children: [
                ButtonWidget(
                  ...
                  title: selectIndexContact == -1 ? 'Submit' : 'Update',
                      ...
                      trailing: Row(
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed: () {
                              _nameValue = contactModel[index].name;
                              _numberValue = contactModel[index].number;
                              _nameController.text = _nameValue;
                              _numberController.text = _numberValue;
